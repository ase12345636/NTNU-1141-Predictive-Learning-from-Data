...
# 輸出目錄（根據配置命名）
RESULTS_DIR = f'results_vit'
CHECKPOINTS_DIR = f'checkpoints_vit'
CHECKPOINTS_FILENAME = f'vit_best'
CHECKPOINTS_FILENAME_FINAL = f'vit_final'
...
def main():
    ...
    model = load_vit_model(num_classes=NUM_CLASSES, device=DEVICE)
