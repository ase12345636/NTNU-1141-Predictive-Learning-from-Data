...
from utils.model_effnet import load_efficientnet_model, freeze_efficientnet_backbone, unfreeze_efficientnet_all
...
# 輸出目錄（根據配置命名）
RESULTS_DIR = f'results_effnet_b{EFFNET_COMPLEXITY}_freeze'
