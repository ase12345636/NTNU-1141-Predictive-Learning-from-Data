...
# 輸出目錄（根據配置命名）
RESULTS_DIR = f'results_densenet'
CHECKPOINTS_DIR = f'checkpoints_densenet'
CHECKPOINTS_FILENAME = f'densenet_best'
CHECKPOINTS_FILENAME_FINAL = f'densenet_final'
...
def main():
    ...
    model = load_densenet_model(num_classes=NUM_CLASSES, device=DEVICE)
